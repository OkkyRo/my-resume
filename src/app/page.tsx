      ...
      <div className="mx-auto max-w-4xl rounded-2xl border border-gray-200 bg-white px-6 py-10 shadow-xl transition-colors dark:border-gray-800 dark:bg-gray-900 sm:px-10 sm:py-14 lg:px-16">
        ...
        <section className="py-8">
          ...
          <p className="mt-3 leading-7 text-gray-600 dark:text-gray-400">
            I'm an Informatics Engineering graduate passionate about Web
            Development, with hands-on experience building both frontend and
            backend applications. I work with technologies such as PHP,
            Laravel, React.js, Next.js, MySQL, and Tailwind CSS to create
            responsive and user-friendly web experiences. I'm always eager to
            learn, solve problems, and explore new technologies while building
            meaningful products with a collaborative team.
          </p>
        </section>
        ...
        <section className="border-t border-gray-200 py-10 dark:border-gray-800">
          ...
          <div className="relative ml-3 mt-8 border-l border-gray-200 pl-8 dark:border-gray-800">

            <div className="relative pb-10">
              <div className="absolute -left-[41px] top-1 flex h-5 w-5 items-center justify-center rounded-full border-4 border-white bg-gray-900 dark:border-gray-900">
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 transition hover:border-gray-300 hover:shadow-sm dark:border-gray-800 dark:bg-gray-800/50 dark:hover:border-gray-700">
                ...
                <p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
                  ...
                  management website using PHP, MySQL, HTML, and CSS. Built
                  task management features and created a responsive,
            ...
            <div className="relative">
              <div className="absolute -left-[41px] top-1 flex h-5 w-5 items-center justify-center rounded-full border-4 border-white bg-gray-400 dark:border-gray-900">
                <div className="h-1.5 w-1.5 rounded-full bg-white" />
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 transition hover:border-gray-300 hover:shadow-sm dark:border-gray-800 dark:bg-gray-800/50 dark:hover:border-gray-700">
                ...
                <p className="mt-4 leading-7 text-gray-600 dark:text-gray-400">
                  ...
                  computer and technical issues, maintained computers and
                  network equipment, and handled payments and basic
                  troubleshooting.
                </p>
        ...
        <section className="border-t border-gray-200 py-10 dark:border-gray-800">
          ...
          <div className="mt-8 grid gap-6">
            <article className="group overflow-hidden rounded-xl border border-gray-200 bg-gray-50 transition hover:border-gray-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-800/50 dark:hover:border-gray-700">
              ...
              <div className="p-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex items-center gap-1 text-sm font-medium text-gray-900 transition group-hover:gap-2 dark:text-gray-100"
                >
                  View project
                  <span>→</span>
                </a>
        ...
        <section className="border-t border-gray-200 py-8 dark:border-gray-800">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {skills.map((skill) => (
              <span
                key={skill}
                className="rounded-md bg-gray-100 px-3 py-1.5 text-sm text-gray-700 dark:bg-gray-800 dark:text-gray-300"
              >
                {skill}
              </span>
            ))}
